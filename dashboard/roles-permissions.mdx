---
title: "Roles and Permissions in the Eventify Dashboard System"
sidebarTitle: "Roles & Permissions"
description: "Eventify uses two roles — admin and user — enforced by a custom Laravel middleware that checks the role label on every protected route."
---
