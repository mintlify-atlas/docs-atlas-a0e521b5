---
title: "Eventify Events API — Full CRUD Endpoints Reference"
sidebarTitle: "Events"
description: "Full CRUD REST API for Eventify events. List, retrieve, create, update, and delete event records at GET, POST, PUT, DELETE /api/event."
---
