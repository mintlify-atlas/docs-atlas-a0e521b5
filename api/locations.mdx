---
title: "Eventify Locations API — Read-Only Endpoint Reference"
sidebarTitle: "Locations"
description: "Read-only REST API for Eventify locations. GET /api/locations returns all venues with address, city, region, country, and geocoded coordinates."
---
