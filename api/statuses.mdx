---
title: "Eventify Statuses API — Read-Only Endpoint Reference"
sidebarTitle: "Statuses"
description: "Read-only REST API for Eventify statuses. GET /api/statuses returns Disponible, Agotado, and Finalizado records used to classify event availability."
---
